...
$(document).ready(function () {
  ...
  function loadAuctions() {
    var orderBy = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "start_time desc";
    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        data.data.forEach(function (auction) {
          var html = "\n                    <div class=\"col-md-4\" data-auction-id=\"".concat(auction.id, "\" id=\"card-auction\">\n                        <div class=\"card mt-5 ").concat(auction.belongToMe ? "owner" : "", " ").concat(auction.winning ? "winning" : "", "\" style=\"border-radius: 10px;\">\n                            <img class=\"card-img-top\" width=\"300\" height=\"300\" src=\"").concat(base_url + '/' + auction.image, "\" alt=\"Auction image\" style=\"border-top-left-radius: 10px;border-top-right-radius: 10px;\" />\n                            <div class=\"card-body\">\n                                <h5 class=\"card-title custom-text-truncate\">").concat(auction.title, "</h5>\n                                <p class=\"card-text custom-text-truncate\">").concat(auction.description, "</p>\n                                <p>Start date: ").concat(auction.start_time, "</p>\n                                <p>Minimum price: $").concat(convertPrice(auction.min_price), "</p>\n                                <p id=\"current_price\">Last bid price: $").concat(convertPrice(auction.current_price), "</p>\n                                <div class=\"input-group mb-3\">\n                                    <input type=\"text\" class=\"form-control\" placeholder=\"Bid price: $ ").concat(auction.current_price, "\"/>\n                                    <div class=\"input-group-append form-control btn btn-outline-secondary\" style=\"display: flex;justify-content: center;align-items: center;border-color: #a0a4a9;\" id=\"btn-bidding\" data-auction-id=\"").concat(auction.id, "\">Bid</div>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                    ");
  ...
  $(document).on("keyup", "#keyword", function (event) {
    event.preventDefault();
    var orderBy = $("#btn-order-by-auctions").data("order-by");
  ...
  $(document).on("click", "#btn-bidding", function (event) {
    ...
    var bidPrice = $(this).parent().find("input").val();
    if (bidPrice == "") {
      return;
    }
    ...
    $.ajax({
      ...
      success: function success(data) {
        if (data.success) {
          toastr.success(data.message);
          $("#card-auction[data-auction-id=\"".concat(auctionId, "\"]>.card")).addClass("winning");
          $("#card-auction[data-auction-id=\"".concat(auctionId, "\"]")).find("#current_price").html("Last bid price: $" + bidPrice);
          changeMoney(data.data.balance_money, data.data.reserved_money);
        } else {
          toastr.error(data.message);
        }
      }
  ...
  $(document).on("click", "#btn-deposit", function (event) {
    event.preventDefault();
    var money = parseInt($(this).parent().find("input").val());
  ...
  function changeMoney(balance) {
    var reserved = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  ...
  function loadMyAuctions() {
    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        data.data.forEach(function (auction) {
          var html = "\n                    <div class=\"card mb-3\">\n                        <div class=\"card-header\">\n                            <h5 class=\"mt-2\">\n                                <strong class=\"custom-text-truncate\">".concat(auction.title, "</strong>\n                            </h5>\n                        </div>\n                        <div class=\"card-body\">\n                            <p class=\"card-text custom-text-truncate\">").concat(auction.description, "</p>\n                            <img class=\"border border-gray border-rounded\" style=\"float: right; position: relative\" src=\"").concat(base_url + '/' + auction.image, "\" alt=\"Auction image\" width=\"200\" height=\"150\"/>\n                            Start date: ").concat(auction.start_time, "<br>\n                            ").concat(auction.status == "ended" ? "<span class=\"border border-danger rounded\">End date: ".concat(auction.updated, "</span><br />") : "", "\n                            Minimum price: $").concat(auction.min_price, "\n                            <br />\n                            <p>Last bid: $").concat(auction.current_price, "</p>\n                            ").concat(auction.status == "active" && auction.belongToMe ? '<button type="button" class="btn btn-danger" id="btn-close-auction" data-auction-id="' + auction.id + '">Close Auction</button>' : "", "\n                        </div>\n                    </div>\n                    ");
  ...
  $(document).on("click", "#btn-create-auction", function (event) {
    ...
    var image = $("#customFile").prop("files")[0];
    if (title == "" || description == "" || minPrice == "" || image == undefined) {
  ...
  $(document).on('click', '#btn-change-password', function (event) {
    ...
    if (newPassword != newPassword_confirmation) {
      toastr.error('New password and new password confirmation do not match');
      return;
    }
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/style"], () => (__webpack_require__("./resources/css/style.scss")))
